...
def build_prompt_zero_shot(idea: str, note: str) -> str:
    ...
    # Zero-shot promt: only has instruction and the pair (IdeaUnit, note).
...
def build_prompt_one_shot(
    ...
    # One-shot prompt has a single labeled example from the same topic.
    # ex_label is 1 or 0 that will be converted to YES or NO.
